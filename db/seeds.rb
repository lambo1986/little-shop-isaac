...
if Rails.env.development? || Rails.env.test?
  ...
  coupon11 = merchant3.coupons.create!(name: "zillionaire", code: "ZILL", percent_off: 0, dollar_off: 1000000000, active: true)
  coupon12 = merchant4.coupons.create!(name: "77%", code: "TRIP7", percent_off: 77, dollar_off: 0, active: true)
  coupon13 = merchant4.coupons.create!(name: "111 Bucks Off", code: "ONEONEONE", percent_off: 0, dollar_off: 100, active: true)
  coupon14 = merchant3.coupons.create!(name: "Luck Threes", code: "THRETHREE", percent_off: 33, dollar_off: 0, active: true)
  coupon15 = merchant3.coupons.create!(name: "26 % Off", code: "2SIX", percent_off: 26, dollar_off: 0, active: true)
  ...
  customer4 = Customer.create!(first_name: "Jim", last_name: "Smith")
  customer5 = Customer.create!(first_name: "Jackie", last_name: "Sams")
  customer6 = Customer.create!(first_name: "George", last_name: "Bartholomew")
  ...
  coupon1 = merchant1.coupons.create!(name: "80% Off", code: "EIGHTYDAWG", percent_off: 80, dollar_off: 0, active: true)
  coupon4 = merchant1.coupons.create!(name: "Nothing Off", code: "NOPE", percent_off: 0, dollar_off: 0, active: true)
  coupon3 = merchant2.coupons.create!(name: "100 Bucks Off", code: "BUCKAROO", percent_off: 0, dollar_off: 100, active: true)
  coupon2 = merchant2.coupons.create!(name: "13 Bucks Off", code: "LUCKY13", percent_off: 0, dollar_off: 15, active: true)
  coupon5 = merchant1.coupons.create!(name: "23 % Off", code: "FAVNUM", percent_off: 23, dollar_off: 0, active: true)
  coupon6 = merchant1.coupons.create!(name: "34 % Off", code: "THIRTYFO", percent_off: 34, dollar_off: 0, active: true)
  coupon7 = merchant1.coupons.create!(name: "44 % Off", code: "FOTYFO", percent_off: 44, dollar_off: 0, active: true)
  coupon8 = merchant2.coupons.create!(name: "57 % Off", code: "FITTYSEV", percent_off: 0, dollar_off: 57, active: true)
  coupon9 = merchant2.coupons.create!(name: "66 % Off", code: "DEALVIL", percent_off: 0, dollar_off: 66, active: true)
  coupon10 = merchant2.coupons.create!(name: "79 % Off", code: "SEVNINE", percent_off: 70, dollar_off: 0, active: true)
  ...
  customer1 = Customer.create!(first_name: "John", last_name: "Smitty")
  customer2 = Customer.create!(first_name: "Jack", last_name: "Sans")
  customer3 = Customer.create!(first_name: "Bertha", last_name: "Bartholet")
